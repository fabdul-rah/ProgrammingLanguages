...
/* Compile with...
    clang 05mainPointers.c
...and then execute with...
	./a.out
This tutorial teaches pointers. A pointer is a memory location. More precisely, 
it is an integer that serves as the address of a memory location.

Here's a real-world analogy. Suppose everyone in the world lived on one very 
long street. Instead of having street addresses like '112 Winona St', they 
would have street addresses like '200343000268'. That is, the street numbers 
would be many digits long (instead of '112'), and there would be no reason to 
